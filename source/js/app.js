...
/***/ function(module, exports, __webpack_require__) {
	...
	var _blocks = __webpack_require__(167);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_blocks.Header, null),
	                _react2.default.createElement(_blocks.Banner, null),
	                _react2.default.createElement(_blocks.Footer, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _banner = __webpack_require__(169);
	...
	var _social = __webpack_require__(171);
	...
	var _copyright = __webpack_require__(172);
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "section",
	                { className: "header" },
	                _react2.default.createElement("a", { href: "#", className: "header-logo" }),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "a",
	                        { href: "#", className: "header-settings-website" },
	                        "сайт exness"
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    "Подлинная свобода распоряжения своими средствами на Форекс"
	                ),
	                _react2.default.createElement(
	                    "h2",
	                    { className: "header-subtitle" },
	                    "Пополняйте счет и выводите прибыть без комиссий"
	                ),
	                _react2.default.createElement(
	                    "a",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Banner = exports.Banner = function (_Component) {
	    ...
	    _createClass(Banner, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "span",
	                    { className: "banner-for-all" },
	                    "Для всех типов счетов"
	                ),
	                _react2.default.createElement(
	                    "span",
	                    { className: "banner-commission" },
	                    _react2.default.createElement("span", { className: "banner-commission-zero" }),
	                    _react2.default.createElement(
	                        "span",
	                        { className: "banner-commission-info" },
	    ...
	    _createClass(Footer, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'section',
	                { className: 'footer' },
	                _react2.default.createElement(_blocks.Social, null),
	                _react2.default.createElement(_blocks.Navigation, null),
	                _react2.default.createElement(_blocks.Copyright, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Social = exports.Social = function (_Component) {
	    _inherits(Social, _Component);

	    function Social() {
	        _classCallCheck(this, Social);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Social).call(this));

	        _this.items = [{ code: 'vk', href: "#", name: 'vkontakte' }, { code: 'ok', href: "#", name: 'odnoklassniki' }, { code: 'tw', href: "#", name: 'twitter' }, { code: 'fb', href: "#", name: 'facebook' }, { code: 'yt', href: "#", name: 'youtube' }, { code: 'in', href: "#", name: 'linkedin' }, { code: 'ks', href: "#", name: 'ksin' }, { code: 'ig', href: "#", name: 'instagram' }, { code: 'gg', href: "#", name: 'google+' }];
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Copyright = exports.Copyright = function (_Component) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "p",
	                        { className: "copyright-info-item" },
	                        "Сайт www.exness.com находится в ведении компании Exness Limited, (регистрационный номер 21927 (IBC 2014). Exness Limited — это внешнеэкономическая компания Сен-Винсента и Гренадин. Компания Exness (Cy) Ltd входит в группу компаний Exness Компания Exness (CY) Ltd управляет сайтом www.exness.eu."
	                    ),
	                    _react2.default.createElement(
	                        "p",
	                        { className: "copyright-info-item" },
	                        "Информация на этом сайте может быть скопирована только с письменного разрешения Exness.",
	                        ...
	                        _react2.default.createElement(
	                            "a",
	                            { href: "#", className: "copyright-info-link" },
	                            "Подробнее"
	                        ),
	                        _react2.default.createElement("br", null),
	                        "© 2008—2016. Exness"
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement("img", { src: "./lib/images/sysec.png", className: "copyright-icons-item" }),
	                    _react2.default.createElement("img", { src: "./lib/images/beliz.png", className: "copyright-icons-item" }),
	                    _react2.default.createElement("br", { className: "copyright-icons-separator" }),
	                    _react2.default.createElement("img", { src: "./lib/images/icon-nqa.png", className: "copyright-icons-item" }),
	                    _react2.default.createElement("img", { src: "./lib/images/icon-sm.png", className: "copyright-icons-item" }),
	                    _react2.default.createElement("img", { src: "./lib/images/cascade.png", className: "copyright-icons-item" })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navigation = exports.Navigation = function (_Component) {
	    ...
	    function Navigation() {
	        ...
	        _this.items = [[{ name: 'О компании', href: '#' }, { name: 'Общие сведения', href: '#' }, { name: 'Почему Exness?', href: '#' }, { name: 'Менеджмент', href: '#' }, { name: 'Регуляция', href: '#' }, { name: 'Служба поддержки клиентов', href: '#' }], [{ name: 'Торговля', href: '#' }, { name: 'Открыть торговый счет', href: '#' }, { name: 'Пополнение и снятие средств', href: '#' }, { name: 'Спецификации контрактов', href: '#' }, { name: 'Правила предоставления кредитного плеча', href: '#' }], [{ name: 'Инструменты', href: '#' }, { name: 'MetaTrader 4', href: '#' }, { name: 'MetaTrader 5', href: '#' }, { name: 'Webtrader', href: '#' }, { name: 'Мобильные платформы', href: '#' }], [{ name: '', href: '' }, { name: 'Экономический календарь', href: '#' }, { name: 'Аналитика', href: '#' }, { name: 'Калькулятор трейдера и конвертер валют', href: '#' }, { name: 'Загрузки', href: '#' }], [{ name: 'Партнерство', href: '#' }, { name: 'Библиотека', href: '#' }, { name: 'FAQ', href: '#' }]];
	        return _this;
	    }
	    ...
	    _createClass(Navigation, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.items.map(function (block, index) {
	                    return _react2.default.createElement(NavigationBlock, {
	                        items: block,
	                        isLast: index === _this2.items.length - 1,
	                        key: 'item-' + index });
	                })
	            );
	        }
	...
	var NavigationBlock = function (_Component2) {
	    _inherits(NavigationBlock, _Component2);

	    function NavigationBlock() {
	        _classCallCheck(this, NavigationBlock);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NavigationBlock).apply(this, arguments));
	    }
	    ...
	    _createClass(NavigationBlock, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'ul',
	                { className: 'navigation-list' + (this.props.items[0].name !== '' ? '' : ' navigation-list-emptyhead') },
	                this.props.items.map(function (item, index) {
	                    ...
	                    return _react2.default.createElement(
	                        'li',
	                        { key: 'item-' + index, className: 'navigation-list-item' + (index === 0 ? ' navigation-list-item-head' : '') },
	                        _react2.default.createElement(
	                            'a',
	                            {
	                                href: item.href,
	                                className: 'navigation-list-item-link' + (index === 0 || _this4.props.isLast ? ' navigation-list-item-link__head' : '') },
	                            item.name ? item.name : ' '
	                        )
	                    );
	                })
